...
<head>
  ...
  <!-- css bao cao thong ke -->
  <link href="{{url('../resources')}}/morris/morris.css" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="{{url('../resources')}}/css/sb-admin-2.min.css" rel="stylesheet">
  <link href="{{url('../resources')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="{{route('dangxuat')}}">Logout</a>
        </div>
      </div>
    </div>
  </div>
